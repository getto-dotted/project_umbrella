...
public class PagingUtil {
	public static String pagingImg(int totalRecordCount, int pageSize, int blockPage, int nowPage, String page, String req) {		
		...
		if (intTemp != 1) {
			...
			// 두번째 페이지 블럭부터 출력됨.
			pagingStr += "" + "<a href='" + page + "nowPage=1'>" + "<img src='"+req+"/images/paging1.gif'></a>";
			pagingStr += "&nbsp;";
			pagingStr += "" + "<a href='" + page + "nowPage=" + (intTemp - blockPage) + "'>"
					+ "<img src='"+req+"/images/paging2.gif'></a>";
		}
		...
		if (intTemp <= totalPage) {
			pagingStr += "<a href='" + page + "nowPage=" + intTemp + "'>" + "<img src='"+req+"/images/paging3.gif'></a>";
			pagingStr += "&nbsp;";
			pagingStr += "<a href='" + page + "nowPage=" + totalPage + "'>" + "<img src='"+req+"/images/paging4.gif'></a>";
		}
